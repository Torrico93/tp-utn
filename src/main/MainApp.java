		...
		while (!fin) {
			...
			case 1:
				if (c1.getPedidosRealizados() < c1.getMaxPedidos()) {
					...
					JOptionPane.showMessageDialog(null, "La caja seleccionada no puede tomar m�s pedidos por hoy");
				}
				break;
			case 2:
			...
			case 3:
				...
				break;
			default:
				JOptionPane.showMessageDialog(null, "Caja inv�lida, por favor elija una de las 3 cajas disponibles");
				break;
			}
			fin = false;

			while (!fin) {
				tipo = Integer.parseInt(JOptionPane.showInputDialog("Qu� desea pedir?\n1 - Cono\n2 - Vaso\n3 - Pote"));
				...
				if (Integer.parseInt(JOptionPane.showInputDialog(
						"Desea pedir algo mas? (Recuerde que si pide un producto que ya pidi�, �ste se sobreescribir�,\n. De otra forma, podr�amos agregar instancias de'\nPedidos y m�s helados a cada Pedido)\n1 - S�\n2 - No")) != 1) {
					fin = true;
				}
			}
